...
#conn = psycopg2.connect(user="guest", password="guest", database="IEL", host="192.168.107.250", port="5432")
conn = psycopg2.connect(user="guest", password="guest", database="IEL-ZNE", host="192.168.107.250", port="5432")
